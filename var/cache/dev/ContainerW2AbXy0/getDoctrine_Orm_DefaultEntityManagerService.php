...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\UtilisateursRepository' => function () {
    return ($this->privates['App\Repository\UtilisateursRepository'] ?? $this->load('getUtilisateursRepositoryService.php'));
}))));
